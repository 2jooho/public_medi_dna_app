...
import com.example.test1.login;
...
public class bmibutton extends Fragment {
    ...
    *//*        // MainActivity에서 받아온 Resource를 ImageView에 셋팅
    ...
    public void text_color(){
        ...
        {
            level_bmi.setTextColor(Color.parseColor("#C8900F"));
        }
         else if(disease_level.equals("낮음    "))
         {
             level_bmi.setTextColor(Color.parseColor("#0D4D1D"));
         }
        else{
             level_bmi.setTextColor(Color.parseColor("#A90C0C"));
         }
    }
