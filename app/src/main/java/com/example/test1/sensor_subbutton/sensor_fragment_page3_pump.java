...
public class sensor_fragment_page3_pump extends Fragment {
    String str2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.sensor_fragment_page3_pump, container, false);
       ...
       MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"information","pump_q");
        ...
        // MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","pump_on");
        //  myClientTask.execute();
        ...
        sw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               ...
               MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","pump_on");
                    ...
                    MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","pump_off");
                    myClientTask.execute();
                }
            }
        });
