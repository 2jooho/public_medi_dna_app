...
public class sensor_fragment_page3_led extends Fragment {
    String str2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.sensor_fragment_page3_led, container, false);
        LinearLayout layout = (LinearLayout) v.findViewById(R.id.fragment_url);
        animationView = v.findViewById(R.id.lottieAnimView);
        MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"information","led_q");
        myClientTask.execute();
        //   setUpAnimation(animationView,1);
        // MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","led_on");
        //  myClientTask.execute();
        ...
        sw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ...
                    MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","led_off");
                    myClientTask.execute();
                }
            }
        });
    ...
    private void setUpAnimation(LottieAnimationView animationView, int a) {
        //        // 재생할 애니메이션 넣어준다.
        animationView.setAnimation("light.json");
    ...
    public class MyClientTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                ...
                in.read(arr);
                System.out.println(new String(arr,"EUC-KR").substring(0,3));
