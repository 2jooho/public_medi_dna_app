...
public class sensor_fragment_page2_light extends Fragment {
...
public int number=0;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.sensor_fragment_page2_light, container, false);
        LinearLayout layout = (LinearLayout) v.findViewById(R.id.fragment_url);
        text=v.findViewById(R.id.text_light);
       ...
       MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"auto","led");
        myClientTask.execute();
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"auto_led",text.getText().toString());
                myClientTask.execute();
            }
        });
