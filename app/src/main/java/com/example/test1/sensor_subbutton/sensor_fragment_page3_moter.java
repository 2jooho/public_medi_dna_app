...
public class sensor_fragment_page3_moter extends Fragment {
    String str2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.sensor_fragment_page3_moter, container, false);
        LinearLayout layout = (LinearLayout) v.findViewById(R.id.fragment_url);
        animationView = v.findViewById(R.id.lottieAnimView);
        MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"information","moter_q");
        myClientTask.execute();
        //   setUpAnimation(animationView,1);
        // MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","moter_on");
        //  myClientTask.execute();
        ...
        sw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ...
                    MyClientTask myClientTask = new MyClientTask("192.168.0.21",9900,"sensor","moter_off");
                    myClientTask.execute();
                }
            }
        });
