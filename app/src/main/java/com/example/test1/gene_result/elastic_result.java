...
public class elastic_result extends Fragment {
    TextView[] gene_find=new TextView[3];
    String db_level[]=new String[1];
    String db_nutrient[]=new String[5];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gene_result_elasticity, container, false);
        int[] gene_arry={R.id.gene_name1,
                R.id.level1, R.id.nutrient};
        ...
        String disease = "Skin Elasticity";
        try {
            for(int i=0; i<1;i++){
