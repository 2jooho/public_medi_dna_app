...
public class gluco_result extends Fragment {
    TextView[] gene_find = new TextView[19];
    String db_level[] = new String[8];
    String db_complication[] = new String[4];
    String db_symptom;
    String db_nutrient[]=new String[14];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gene_result_glucose, container, false);
