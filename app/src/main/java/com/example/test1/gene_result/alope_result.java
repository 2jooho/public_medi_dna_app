...
public class alope_result extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gene_result_alope, container, false);
        int[] gene_arry={R.id.gene_name1,R.id.gene_name2,
                R.id.level1,R.id.level2, R.id.nutrient};
    ...
    public void text_color(int i){
        ...
        else if(db_level[i].equals("낮음    "))
        {
            ...
            gene_find[i+2].setTextColor(Color.parseColor("#A90C0C"));
            gene_find[i+2].setBackgroundResource(R.drawable.gene_result_up);
        }
    }
