...
public class caffeine_result extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gene_result_caffeine, container, false);
        ...
        String disease = "Caffeine Metabolism";
        try {
            for (int i = 0; i < 2; i++) {
            ...
            gene_find[4].setText(db_complication[0] +" "+ db_complication[1] +" "+ db_complication[2] +" "+ db_complication[3]+" "+ db_complication[4]);
