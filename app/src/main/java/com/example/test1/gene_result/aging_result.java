...
public class aging_result extends Fragment {
    TextView[] gene_find=new TextView[3];
    String db_level[]=new String[1];
    String db_nutrient[]=new String[8];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gene_result_aging, container, false);
        int[] gene_arry={R.id.gene_name1,R.id.level1,R.id.nutrient};
